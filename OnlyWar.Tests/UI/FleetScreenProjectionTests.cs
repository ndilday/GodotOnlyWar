...
public class FleetScreenProjectionTests
{
    [Fact]
    public void CreateFleetNode_GroupsLoadedSquadsByOwningUnit()
    {
        ...
        TreeNode fleetNode = new FleetScreenProjector().BuildFleetNode(taskForce, null);
    ...
    public void CreateLoadedUnitNodes_PreservesSquadTypeOrderAndSortsNamesWithinType()
    {
        ...
        IReadOnlyList<TreeNode> unitNodes = new FleetScreenProjector().BuildLoadedUnitNodes(ship, null);
    ...
    public void CanTransferSquadToShip_AllowsShipsInSameFleetWithCapacity()
    {
        ...
        bool canTransfer = FleetTransferService.CanTransferSquadToShip(squad, destinationShip);
    ...
    public void TransferSquadToShip_MovesSquadAndRefreshesCapacity()
    {
        ...
        FleetTransferService.TransferSquadToShip(squad, destinationShip);
    ...
    public void CanTransferUnitToShip_RequiresCapacityForAllSquadsTogether()
    {
        ...
        bool canTransfer = FleetTransferService.CanTransferUnitToShip(secondCompany, sourceShip, destinationShip);
    ...
    public void TransferUnitToShip_MovesEverySquadOfUnitFromSourceOnly()
    {
        ...
        FleetTransferService.TransferUnitToShip(secondCompany, sourceShip, destinationShip);
