...
-- Table: Mission
CREATE TABLE Mission (Id INTEGER PRIMARY KEY UNIQUE NOT NULL, MissionType INTEGER NOT NULL, RegionId INTEGER NOT NULL REFERENCES Region (Id), MissionSize INTEGER NOT NULL, DefenseTypeId INTEGER);

-- Table: Order
CREATE TABLE SquadOrder (Id INTEGER PRIMARY KEY UNIQUE NOT NULL, MissionId INTEGER NOT NULL REFERENCES Mission (Id), Disposition INTEGER NOT NULL, IsQuiet BOOLEAN NOT NULL, IsActivelyEngaging BOOLEAN NOT NULL, Aggression INTEGER NOT NULL);

-- Table: SquadOrder
CREATE TABLE SquadOrder (SquadId INTEGER NOT NULL REFERENCES Squad (Id), OrderId INTEGER NOT NULL REFERENCES Order (Id));
