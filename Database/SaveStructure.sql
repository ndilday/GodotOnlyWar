...
-- Table: Region
CREATE TABLE Region (Id INTEGER PRIMARY KEY UNIQUE NOT NULL, PlanetId INTEGER NOT NULL REFERENCES Planet (Id), RegionNumber INTEGER NOT NULL, RegionType INTEGER NOT NULL, IsUnderAssault BOOLEAN NOT NULL);

-- Table: RegionFaction
CREATE TABLE RegionFaction (RegionId INTEGER REFERENCES Region (Id) NOT NULL, FactionId INTEGER NOT NULL, IsPublic BOOLEAN NOT NULL, Population BIGINT NOT NULL, PDFMembers INTEGER NOT NULL);
...
-- Table: DefendRegionOrder
CREATE TABLE DefendRegionOrder (OrderId INTEGER PRIMARY KEY UNIQUE NOT NULL, SquadId INTEGER NOT NULL REFERENCES Squad (Id), DefendRegionId INTEGER NOT NULL REFERENCES Region (Id), BorderRegionId INTEGER NOT NULL REFERENCES Region (Id));

-- Table: AttackRegionOrder
CREATE TABLE DefendRegionOrder (OrderId INTEGER PRIMARY KEY UNIQUE NOT NULL, SquadId INTEGER NOT NULL REFERENCES Squad (Id), AttackRegionId INTEGER NOT NULL REFERENCES Region (Id));
