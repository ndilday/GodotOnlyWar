...
**Battle Loadouts**
- Equipment is allocated from the current doctrine and character kits at the start of each battle. If a casualty leaves a weapon uncarried, the next battle allocates that equipment to the best eligible surviving carrier; there is no separate post-battle mutation pass.
