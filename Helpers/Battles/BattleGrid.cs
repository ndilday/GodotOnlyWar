...
namespace OnlyWar.Helpers.Battles
{
    public class BattleGrid
    {
        ...
        public event SquadPlacedHandler OnSquadPlaced;
        ...
        {
            int top = short.MinValue;
            int bottom = short.MaxValue;
            int left = short.MaxValue;
            int right = short.MinValue;
        ...
        public Tuple<int, int> GetCurrentGridSize()
        {
            ...
            return new Tuple<int, int>((ushort)(maxX - minX), (ushort)(maxY - minY));
        }
        ...
        public bool IsAdjacentToEnemy(int soldierId)
        {
            ...
            foreach (Tuple<int, int> location in locations)
            {
                Tuple<int, int>[] testPositions = new Tuple<int, int>[4]
                    {
                    new Tuple<int, int>(location.Item1, (short)(location.Item2 - 1)),
                    new Tuple<int, int>(location.Item1, (short)(location.Item2 + 1)),
                    new Tuple<int, int>((short)(location.Item1 - 1), location.Item2),
                    new Tuple<int, int>((short)(location.Item1 + 1), location.Item2)
                    };
                foreach (Tuple<int, int> testPosition in testPositions)
                {
        ...
        private Tuple<int, int> PlaceSquadHorizontally(BattleSquad squad, Tuple<int, int> bottomLeft, Tuple<ushort, ushort> squadBoxSize)
        {
        ...
        private Tuple<int, int> PlaceSquadVertically(BattleSquad squad, Tuple<int, int> bottomLeft, Tuple<ushort, ushort> squadBoxSize)
        {
