...
namespace OnlyWar.Helpers.Missions.Recon
{
    public class DetectedMissionStep : IMissionStep
    {
        ...
        public void ExecuteMissionStep(MissionContext context, float marginOfSuccess, IMissionStep returnStep)
        {
            ...
            Faction opposingFaction = context.Order.Mission.Region.RegionFactionMap.Values.First(rf => !rf.PlanetFaction.Faction.IsPlayerFaction && !rf.PlanetFaction.Faction.IsDefaultFaction).PlanetFaction.Faction;
            ...
            for (int i = 0; i < numberOfOpposingSquads; i++)
            {
                ...
                Squad squad = SquadFactory.GenerateSquad(squadTemplate, $"{opposingFaction.Name} {context.Order.Mission.Region.Name} Recon Squad {i}");
