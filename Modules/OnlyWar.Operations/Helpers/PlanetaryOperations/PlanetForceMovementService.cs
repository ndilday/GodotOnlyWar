    ...
    public static class PlanetForceMovementService
    {
            ...
            IOperationsPersonnelSurface personnel = null)
        {
            return Land(sector, planet, destination,
                new MovementParty(selectedSquads ?? [], []), currentDate, personnel);
        }

        // currentDate stamps the postings this movement creates; it is an explicit input rather than
        // a read of the active campaign (SB-05a).
        public static ForceMovementResult Land(
            Sector sector,
            Planet planet,
            Region destination,
