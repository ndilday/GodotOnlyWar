...
namespace OnlyWar.Operations.Turns
{
    ...
    /// </summary>
    public sealed class MissionAftermathProcessor
    {
        ...
        public static void RemoveConsumedSpecialMissions(IEnumerable<Order> playerOrdersThisTurn)
        {
        ...
        public static void CleanupResolvedPlayerOrders(
            Sector sector,
        ...
        public static void PruneInvalidSpecialMissions(IEnumerable<Planet> planets)
        {
