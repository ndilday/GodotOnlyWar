...
namespace OnlyWar.Operations.Turns
{
    ...
    /// </summary>
    public static class ConsumptionTurnProcessor
    {
        ...
        private static Action<Region, long, Faction> _recordScenarioBlighting;
        private static Action<RegionFaction, long, Faction> _recordScenarioCivilianKills;

        public static void ConfigureScenarioMetrics(
            Action<Region, long, Faction> recordScenarioBlighting,
            Action<RegionFaction, long, Faction> recordScenarioCivilianKills)
        {
            _recordScenarioBlighting = recordScenarioBlighting;
        ...
        /// </summary>
        public static void ResolveExpansion(Planet planet)
        {
            ResolveExpansion(planet, _ => true);
        }

        public static void ResolveHiddenExpansion(Planet planet)
        {
        ...
        public static (Region Destination, long Movers) PlanExpansion(
        ...
        public static void ApplyExpansion(RegionFaction source, Region destination, long amount)
        {
        ...
        public static void ResolveFeeding(Region region)
        {
        ...
        public static void ResolveHiddenFeeding(Region region)
        {
        ...
        public static void ResolveFeeding(RegionFaction consumer, double troops)
        {
            ...
            _recordScenarioBlighting?.Invoke(
                region,
                stripped,
        ...
        public static void ResolvePredation(Region region, long organized, Faction attacker)
        {
            List<RegionFaction> prey = region.RegionFactionMap.Values
            ...
            Faction attacker)
        {
            ...
            for (int i = 0; i < prey.Count; i++)
            {
                ...
                _recordScenarioCivilianKills?.Invoke(target, share, attacker);
                applied += share;
            }
        }

        public static void RecoverCarryingCapacity(Region region)
        {
