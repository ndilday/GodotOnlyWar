...
namespace OnlyWar.Helpers.PlanetaryOperations
{
    ...
    public static class RegionalOrderEligibilityService
    {
            ...
            RecruitmentProgram program)
        {
            ...
            ChapterOperationalDoctrine doctrine = CurrentCampaignReadinessContext.ResolveDoctrine(squad);
            SquadReadinessSnapshot readiness = SquadReadinessService.Evaluate(squad, program: program, doctrine: doctrine);
