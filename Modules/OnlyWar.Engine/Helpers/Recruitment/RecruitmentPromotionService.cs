...
namespace OnlyWar.Helpers.Recruitment
{
    ...
    public sealed record BlackCarapacePlanResult(
        bool Succeeded,
        string Message,
    ...
    /// </summary>
    public sealed class RecruitmentPromotionService
    {
        private const float BlackCarapaceReadinessRangedRating = 105f;

        private readonly GameSession _session;

        public RecruitmentPromotionService(GameSession session)
        {
        ...
        public RecruitmentPromotionResult ScheduleBlackCarapace(
            int soldierId,
        ...
        public BlackCarapacePlanResult EvaluateBlackCarapace(
            int soldierId,
            int devastatorSquadId)
        {
            PlayerForce force = _session.Sector.PlayerForce;
