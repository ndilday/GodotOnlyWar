...
namespace OnlyWar.Helpers.Battles.Aftermath
{
        ...
        IPlayerNarrativeEventSink
    {
            ...
            int woundsReceived)
        {
            ...
            return force.GetCampaignEventRecorder().RecordBattleParticipation(
                soldier,
                context,
                enemiesTakenDown,
                woundsReceived,
        ...
        {
            PlayerForce force = RequirePlayerForce();
            return force.GetCampaignEventRecorder().RecordIncapacitated(
                soldier,
                context,
                definingLocation,
                causingWeapon,
        ...
        public CampaignEvent RecordSquadLeaderUnavailable(
            ...
            BattleEventContextSnapshot context) =>
            RequirePlayerForce().GetCampaignEventRecorder().RecordSquadLeaderUnavailable(
        ...
        {
            PlayerForce force = RequirePlayerForce();
            return force.GetCampaignEventRecorder().RecordLastSurvivor(
                soldier,
                payload,
                BuildSquadEntity(soldier));
        }
        ...
        {
            PlayerForce force = RequirePlayerForce();
            return force.GetCampaignEventRecorder().RecordSquadHeldAgainstOdds(
                squadId,
                squadName,
                payload,
                participants);
            ...
            string victimDisplayName)
        {
            ...
            force.GetCampaignEventRecorder().RecordKillMilestones(
                soldier,
                previousTotal,
                newTotal,
                opposingFactionId,
