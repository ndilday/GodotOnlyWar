...
namespace OnlyWar.Helpers
{
    ...
    public sealed class CharacterAvailabilityService
    {
            ...
            ChapterOperationalDoctrine doctrine = null)
        {
            ...
            DutyReadinessEvaluation duty = DutyReadinessService.Evaluate(character, doctrine: CurrentCampaignReadinessContext.ResolveDoctrine(character.AssignedSquad, doctrine), recruitmentProgram: CurrentCampaignReadinessContext.ResolveProgram(character.AssignedSquad));
            if (!duty.IsDutyReady)
            {
