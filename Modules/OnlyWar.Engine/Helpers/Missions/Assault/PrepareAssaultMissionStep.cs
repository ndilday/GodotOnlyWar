...
namespace OnlyWar.Helpers.Missions.Assault
{
    public class PrepareAssaultMissionStep : IMissionStep
    {
        ...
        internal List<BattleSquad> AssembleDefendingForce(
            ...
            long attackerBattleValue = 0, MissionCampaignInputs campaign = null)
        {
            ...
            List<BattleSquad> landedDefenders = defendingSquads
                .Select(s => BattleSquadFactory.Create(
                    ...
                    s.Faction?.IsPlayerFaction == true
                        ? campaign?.Doctrine
                        : null,
                    campaign?.Recruitment, campaign?.Equipment))
        ...
        internal static List<Squad> GetRegionalDefensiveSquads(RegionFaction defendingRegionFaction, IReadOnlyList<StrategicInvasionForce> forces = null)
        {
