...
namespace OnlyWar.Domain.Equippables
{
    ...
    public class RangedWeapon
    {
        ...
        public AmmunitionReservePool ReservePool { get; }
        ...
        public RangedWeapon DeepCopy(AmmunitionReservePool reservePool)
        {
        ...
        public void CopyLiveStateFrom(RangedWeapon source)
        {
