...
namespace OnlyWar.Domain
{
    public class Sector
    {
        ...
        private long _nextStrategicInvasionForceId;
        ...
        public Sector()
        {
            ...
            _nextStrategicInvasionForceId = 1;
        }
        ...
        public void AddNewOrder(Order newOrder)
        {
            ...
            newOrder.RegisteredSector = this;
        }
        ...
        {
            if(_orders.TryGetValue(existingOrder.Id, out Order registered)
                && ReferenceEquals(registered, existingOrder))
            {
                _orders.Remove(existingOrder.Id);
                existingOrder.RegisteredSector = null;
            }
        }
