...
namespace OnlyWar.Domain.Planets
{
    public class RegionFaction
    {
        ...
        {
            get => _contentment;
            set => _contentment = float.IsNaN(value) ? 70f : System.Math.Clamp(value, 0f, 100f);
        }
        ...
        // it stays unmanned under enemy control (RegionControlTurnProcessor.DecayUnmannedDefenses), so a remnant
