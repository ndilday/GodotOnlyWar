...
namespace OnlyWar.Domain
{
    public sealed class GameRulesData
    {
        ...
        public GameRulesData(GameRulesBlob gameBlob)
        {
            ArgumentNullException.ThrowIfNull(gameBlob);
        ...
        public ChapterGenerationDoctrine GetPlayerChapterDoctrine(string profileKey = null)
        {
            if (string.IsNullOrWhiteSpace(profileKey))
            {
