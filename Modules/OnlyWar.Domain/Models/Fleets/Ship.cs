...
namespace OnlyWar.Models.Fleets
{
    ...
    public class Ship
    {
        ...
        public int LoadedSoldierCount => PhysicalPresence.LoadedSoldierCount(this);
        ...
        public void LoadSquad(Squad squad)
        {
            ...
            int count = PhysicalPresence.PresentCount(squad);
        ...
        public void StationAdministrativeFormation(Squad squad)
        {
            ...
            if (AvailableCapacity
                < PhysicalPresence.PresentCount(squad))
            {
                throw new InvalidOperationException(
        ...
        public void RemoveAdministrativeFormation(Squad squad) =>
            _administrativeStations.Remove(squad);

        public void BoardIndividual(Soldiers.PlayerSoldier soldier)
        {
        ...
        public void DisembarkIndividual(Soldiers.PlayerSoldier soldier) =>
