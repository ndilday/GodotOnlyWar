            ...
            IDbConnection connection)
        {
            ...
            command.CommandText = @"
                SELECT ProfileKey, GhostSourceChancePerEmptyTile, MinimumGhostSourcesPerSector,
                       ...
                       ExceptionalAssassinationMargin, DormantEmergenceMinimumPopulation,
            ...
            while (reader.Read())
            {
                profiles.Add(new FactionBehaviorRulesProfile(
                    ...
                    Convert.ToInt64(reader.GetValue(17)), Convert.ToDouble(reader.GetValue(18)),
                    Convert.ToDouble(reader.GetValue(19)), Convert.ToDouble(reader.GetValue(20)),
                    ...
                    Convert.ToDouble(reader.GetValue(31))));
            }
            return profiles;
        }
