...
namespace OnlyWar.Persistence.Storage
{
    ...
    {
        public const int PostTurnAutosaveRetention = 3;
        ...
        public SaveGameEntry CreateManualSave(
            string displayName,
            string campaignName,
        ...
        public SaveGameEntry OverwriteManualSave(
        ...
        public SaveGameEntry SavePostTurnAutosave(
            string campaignName,
            Action<string> writeSave)
        {
        ...
        public SaveGameEntry SaveProtectedPreTurn(
            string campaignName,
            Action<string> writeSave)
        {
            string savePath = Path.Combine(
        ...
        public SaveGameEntry SaveInitialAutosave(
            string campaignName,
            Action<string> writeSave)
        {
        ...
        public void DeleteManualSave(string savePath)
        {
