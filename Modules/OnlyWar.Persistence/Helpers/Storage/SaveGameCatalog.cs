...
namespace OnlyWar.Persistence.Storage
{
    ...
    public sealed record SaveGameEntry(
        string FilePath,
        string DisplayName,
        string CampaignName,
        Date CampaignDate,
    ...
    {
        public bool IsCompatible => Compatibility is SaveGameCompatibility.Compatible
    ...
    /// </summary>
    public sealed class SaveGameCatalog
    {
        private readonly string _saveDirectory;

        public SaveGameCatalog(string saveDirectory)
        {
            _saveDirectory = Path.GetFullPath(
                saveDirectory ?? throw new ArgumentNullException(nameof(saveDirectory)));
        }

        public IReadOnlyList<SaveGameEntry> Discover()
        {
