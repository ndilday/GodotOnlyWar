...
namespace OnlyWar.Helpers
{
    ...
    // It lives with the runtime logging facilities so Operations and Battles can use it without
    // creating a dependency from either bounded context onto the other.
