...
namespace OnlyWar.Campaign.Command
{
    public static class ChapterChronicleBrowser
    {
        ...
        public static IReadOnlyList<ChronicleFilter> GetAvailableFilters(
        ...
        public static IReadOnlyList<ChronicleEntryViewModel> GetPage(
            ChapterChronicleLedger chronicle,
            CampaignEventLedger events,
            Sector sector,
        ...
        public static IReadOnlySet<ChronicleFilter> GetCategories(
            ChapterChronicleEntry entry,
            CampaignEventLedger events)
        {
