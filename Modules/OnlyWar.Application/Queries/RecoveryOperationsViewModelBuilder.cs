    ...
    public sealed class RecoveryOperationsViewModelBuilder
    {
            ...
            MedicalProcedureType? selectedProcedureType = null)
        {
            ...
            if (IsAwaitingReunion(patient))
            {
                ...
                return new(queue, summary, BuildSquadStatus(force, patient), null, [], null,
        ...
        private static CareDestinationView ProjectDestination(CareDestinationCandidate value) => new(
        ...
        private static RecoverySquadStatus BuildSquadStatus(PlayerForce force, PlayerSoldier patient)
        {
            Squad squad = patient.AssignedSquad;
            SquadStrengthSnapshot strength = SquadStrengthSnapshotBuilder.Build(squad, program: force?.RecruitmentProgram, doctrine: force?.Army?.OperationalDoctrine);
