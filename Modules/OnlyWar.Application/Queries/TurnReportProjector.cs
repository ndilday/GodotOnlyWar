...
/// <summary>
/// Turns one resolved turn into the player-facing report cards. This is campaign policy, not
/// presentation: it decides what the player is allowed to learn about an NPC-run mission from the
/// region's intel, which battles may be reviewed, and how each outcome is worded. It lived on the
/// end-of-turn dialog until SB-11b; the dialog now only renders what this produces.
/// </summary>
internal static class TurnReportProjector
{
